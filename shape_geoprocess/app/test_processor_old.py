...
'''
Note: Fiona will inherit env vars from GDAL for S3 credentials/connection info.
'''
...
r = requests.put('http://api/watersheds/geometry/f2e722aa-e552-41f1-b6f5-8b9d6f267194?key=appkey', 
    json=geojson_data)
print(r.status_code)
print(r.text)
# Write to geojson file
with open('/usr/src/app/LRH_Scioto.json', 'w') as outfile:
