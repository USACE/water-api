...
BEGIN
    ...
    INSERT into timeseries(datasource_id, datasource_key, latest_time, latest_value) VALUES
        (nws_level_ds_id, 'KANW2.Stage.Action', '2021-09-19T18:35:00Z', 25),
        (nws_level_ds_id, 'KANW2.Stage.Flood', '2021-09-19T18:35:00Z', 27),
        (nws_level_ds_id, 'KANW2.Stage.Moderate Flood', '2021-09-19T18:35:00Z', 30),
        (nws_level_ds_id, 'KANW2.Stage.Major Flood', '2021-09-19T18:35:00Z', 35);
