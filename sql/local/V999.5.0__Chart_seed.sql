...
BEGIN
    ...
    INSERT INTO chart(id, location_id, slug, name, type, provider_id) VALUES
    -- alum-creek-dam-profile already in seed data
    ('ff03ac20-439c-4504-8c33-8819db2acb23', (SELECT id from v_location WHERE lower(code) = 'alumcr' and datatype = 'cwms-location' AND provider = 'lrh'), 'alum-creek-dam-profile', 'Alum Creek Dam Profile Chart', 'dam-profile-chart', '2f160ba7-fd5f-4716-8ced-4a29f75065a6'),
    ('1c89c8f2-b7ef-4cc6-a877-ac6c21d48e87', (SELECT id from v_location WHERE lower(code) = 'alumcr' and datatype = 'cwms-location' AND provider = 'lrh'), 'lrh-alum-creek-example-scatter', 'Alum Creek Dam Scatter Chart', 'example-scatter', '2f160ba7-fd5f-4716-8ced-4a29f75065a6');
    -- ('41f2f75e-9472-4339-bac6-be898e809aee', (SELECT id from location where slug = 'atwood-1'), 'lrh-atwood-dam-profile', 'Atwood Dam Profile Chart', 'dam-profile-chart', '2f160ba7-fd5f-4716-8ced-4a29f75065a6'),
    -- ('ec15892b-bfde-421f-adfa-9f7c0f906ec2', (SELECT id from location where slug = 'beachcity'), 'lrh-beachcity-dam-profile', 'Beach City Dam Profile Chart', 'dam-profile-chart', '2f160ba7-fd5f-4716-8ced-4a29f75065a6'),
    -- ('8cc22bfd-678c-48ad-a35a-ff427c481cc6', (SELECT id from location where slug = 'bolivar'), 'lrh-bolivar-dam-profile', 'Bolivar Dam Profile Chart', 'dam-profile-chart', '2f160ba7-fd5f-4716-8ced-4a29f75065a6'),
    -- ('945cd8de-39ec-4a75-836d-f14c0f609571', (SELECT id from location where slug = 'bluestone'), 'lrh-bluestone-dam-profile', 'Bluestone Dam Profile Chart', 'dam-profile-chart', '2f160ba7-fd5f-4716-8ced-4a29f75065a6');
