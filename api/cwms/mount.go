...
func Mount(conn *pgxpool.Pool, e *echo.Echo, config *app.Config) {
	...
	// LOCATIONS; refactored to locations API
	...
	// // LOCATION LEVEL KINDS; refactored into timeseries API
	...
	// // Sync Locations; refactored into locations api
	// key.POST("/sync/locations", s.SyncLocations)

	// Offices; refactored into providers API
	// public.GET("/offices", s.ListOffices)

	// Projects; refactored into locations API
